# example-inspec-overlay-profile-red-hat-enterprise-linux-7-stig-overlay
...
```bash
# How to run
sudo inspec exec https://github.com/ejaronne/example-inspec-overlay-profile-red-hat-enterprise-linux-7-stig-overlay/archive/main.tar.gz --input-file <path_to_your_input_file/name_of_your_input_file.yml> --reporter=cli json:<path_to_your_output_file/name_of_your_output_file.json> 
```
...
mkdir profiles
cd profiles
git clone https://github.com/ejaronne/example-inspec-overlay-profile-red-hat-enterprise-linux-7-stig-overlay.git
inspec archive example-inspec-overlay-profile-red-hat-enterprise-linux-7-stig-overlay
...
```
cd example-inspec-overlay-profile-red-hat-enterprise-linux-7-stig-overlay
git pull
cd ..
inspec archive example-inspec-overlay-profile-red-hat-enterprise-linux-7-stig-overlay --overwrite
sudo inspec exec <name of generated archive> --input-file <path_to_your_input_file/name_of_your_input_file.yml> --reporter=cli json:<path_to_your_output_file/name_of_your_output_file.json> 
```
...
To report a bug or feature request, please open an [issue](https://github.com/ejaronne/example-inspec-overlay-profile-red-hat-enterprise-linux-7-stig-overlay/issues/new).
